		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Library App",
									"targetURL": "#zkzilibraryproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zkzilibraryproject-display": {
								"semanticObject": "zkzilibraryproject",
								"action": "display",
								"description": "Library Fiori Application",
								"title": "Library App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zkzilibraryproject",
									"url": sap.ui.require.toUrl("zkzilibraryproject")
								}
							}
						}
					}
